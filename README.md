...
The repository is organized into two main data folders:

- **`goc_data_source/`** - Contains the original IRCC/Government of Canada Excel files downloaded from the open data portal
- **`goc_data_processed/`** - Contains the processed CSV files generated by the Python extraction scripts

### Source Data Files (in `goc_data_source/` folder)
...
### Processed Data Files (in `goc_data_processed/` folder)
